...
def main():
    ...
    client5 = repo.clients.create(
        first_name="Ivan", last_name="Petrenko", email="ivan.petrenko@example.com", phone="0971112233")
    client6 = repo.clients.create(
        first_name="Natalia", last_name="Koval", email="natalia.koval@example.com", phone="0672223344")
    client7 = repo.clients.create(first_name="Oleksandr", last_name="Tkachenko",
                                  email="o.tkachenko@example.com", phone="0503334455")
    client8 = repo.clients.create(
        first_name="Tetyana", last_name="Lysenko", email="tetyana.l@example.com", phone="0634445566")
    client9 = repo.clients.create(
        first_name="Serhiy", last_name="Melnyk", email="serhiy.melnyk@example.com", phone="0995556677")
    client10 = repo.clients.create(
        first_name="Viktoriya", last_name="Shevchuk", email="v.shevchuk@example.com", phone="0686667788")
    client11 = repo.clients.create(
        first_name="Andriy", last_name="Kuzmenko", email="andriy.k@example.com", phone="0737778899")
    client12 = repo.clients.create(
        first_name="Iryna", last_name="Zubko", email="iryna.zubko@example.com", phone="0968889900")
    client13 = repo.clients.create(
        first_name="Pavlo", last_name="Klimenko", email="pavlo.klimenko@example.com", phone="0970001122")
    client14 = repo.clients.create(
        first_name="Halyna", last_name="Bondar", email="halyna.bondar@example.com", phone="0671113355")
    client15 = repo.clients.create(
        first_name="Mykola", last_name="Boyko", email="mykola.boyko@example.com", phone="0502224466")
    client16 = repo.clients.create(
        first_name="Yuliya", last_name="Romanenko", email="yuliya.r@example.com", phone="0633335577")
    client17 = repo.clients.create(
        first_name="Roman", last_name="Volkov", email="roman.volkov@example.com", phone="0994446688")
    client18 = repo.clients.create(
        first_name="Zlata", last_name="Sydorenko", email="zlata.s@example.com", phone="0685557799")
    client19 = repo.clients.create(
        first_name="Maksym", last_name="Bilous", email="maksym.bilous@example.com", phone="0736668800")
    client20 = repo.clients.create(
        first_name="Kateryna", last_name="Vasilenko", email="kateryna.v@example.com", phone="0967779911")
    client21 = repo.clients.create(
        first_name="Denys", last_name="Hrytsenko", email="denys.h@example.com", phone="0978880022")
    client22 = repo.clients.create(first_name="Oksana", last_name="Marchenko",
                                   email="oksana.marchenko@example.com", phone="0679991133")
    client23 = repo.clients.create(
        first_name="Vasyl", last_name="Kostenko", email="vasyl.kostenko@example.com", phone="0500002244")
    client24 = repo.clients.create(
        first_name="Olha", last_name="Savchuk", email="olha.savchuk@example.com", phone="0631113355")
